...
# ATUALIZA UM PIVÔ EXISTENTE
echo "Atualizando um pivô existente..."
curl -X PUT http://localhost:3333/pivots/$PIVOT_ID \
-H "Content-Type: application/json" \
-H "Authorization: Bearer $USER_TOKEN" \
-d '{
  "description": "Descrição atualizada para o pivô",
  "flowRate": 16,
  "minApplicationDepth": 4.5
}'
